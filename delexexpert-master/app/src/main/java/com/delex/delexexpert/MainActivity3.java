...
//        Log.d(TAG, "onResume: ");
    ...
    public class MyJavascriptInterface {
        ...
        public void getDeviceToken(String userId) {
            ...
            sendPushToken(userId, mPushToken);
...
//        }
     ...
     * @param pushToken
     */
    public void sendPushToken(String userId, String pushToken) {
        ...
        if (pushToken != null) {
            ...
            RetrofitUtil.retrofitService(this, call1, new RetrofitUtil.RetrofitResponseImpl<Object>() {
                @Override
